...
def fetch_country_code(country: str):
    ...
    if len(country)==2:
        ...
        try:
            country_data=geoloc_data[geoloc_data['country_code']==str.upper(country)]
...
def fetch_country_name(country: str):
    ...
    if len(country)>2:
        ...
        try:
            ...
            print(f"Some error occurred while trying to fetch the provided location. Localazing to random location: {country_data['country_name']}")
